# -*- coding: utf-8 -*-
"""v26 最终校验：页码规则、目录页码与印刷页一致、中缝、结构。"""
import re
import zipfile
...
DOCX = r"T:\创新创业\OwO-master\docs\Cuttle——情境原生智能输入系统-参赛商业计划书-专业视觉精修版-v26.docx"
PDF = r"T:\创新创业\OwO-master\docs\Cuttle——情境原生智能输入系统-参赛商业计划书-专业视觉精修版-v26.pdf"
